...
# will be made.
KERNEL_IMAGE_DTB = arch/arm64/boot/dts/qcom/sm8150-v2-vayu.dtb
...
# Paths for lineage 19.1 kernel build
...
DEB_TOOLCHAIN = vim, linux-initramfs-halium-generic:arm64, bc, bison, build-essential, ccache, curl, flex, git, git-lfs, gnupg, gperf, imagemagick, libelf-dev,  libncurses5-dev, libsdl1.2-dev, libssl-dev, libxml2, libxml2-utils, lzop, pngcrush, rsync, schedtool, squashfs-tools, xsltproc, zip, zlib1g-dev, python3, python-is-python3, binutils-aarch64-linux-gnu, clang-android-12.0-r416183b
